"""Example demonstrating Yelp data analysis capabilities of the UDA package.

This script shows how to:
1. Load and process Yelp business and review data
2. Generate comprehensive restaurant profiles
3. Analyze trends and patterns in dining preferences
"""
...
def run_yelp_analysis(
    ...
    """Run a Yelp data analysis demonstration.
    ...
    business_file = str(Path(data_path) / "yelp_academic_dataset_business.json")
    review_file = str(Path(data_path) / "yelp_academic_dataset_review.json")

    data_loader.load_businesses(business_file)
    data_loader.load_reviews(review_file)
