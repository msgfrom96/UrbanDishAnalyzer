"""Example demonstrating taste profile analysis capabilities of the UDA package.

This script shows how to:
1. Generate detailed taste profiles from reviews
2. Analyze dining preferences and patterns
3. Generate visualizations of taste profiles
"""
...
def run_taste_profile_analysis(
    data_path: str, output_path: str, metro_area: str = "St. Petersburg"
) -> None:
    """Run a taste profile analysis demonstration.
...
if __name__ == "__main__":
    run_taste_profile_analysis("data/", "output/")
